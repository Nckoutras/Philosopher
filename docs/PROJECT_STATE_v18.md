...
>
> **Generated:** 2026-06-15 (v18 rotation) · **Last updated:** 2026-06-15 (session delta #277–#313; current main `70059bc3`)
...
**alembic_version = `025_create_mirror_saves`** (022–025 logged in v18; v17's table had stopped at 021)
...
> **Note:** `alembic_version` is now `025_create_mirror_saves`. Confirm the Oregon DB has applied 022–025 (Render auto-runs alembic on deploy; verify if in doubt).
