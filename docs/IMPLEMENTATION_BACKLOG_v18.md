# THE WISE ROOM — Implementation Backlog v18
...
>
> **Generated:** 2026-06-15 (v18 rotation) · **Last updated:** 2026-06-15 (P2-SMOKE-10/11 closed; Weekly Reading reader shipped; migration head → 025; current main `70059bc3`)
>
> **How to read this file:**
> - This v18 file supersedes v17 and all prior backlog files.
> - Where v18 conflicts with v17, v18 wins.
>
> **Companion documents:**
> - `PROJECT_STATE_v18.md` — current project state
> - `HANDOFF_BRIEF_v18.md` — continuity and implementation history
> - `SCREENS_TRACKING_v6.md` — full screen inventory
