# GREAT MINDS — Screens Tracking v7
...
>
> **Total: 68 screens** (v7 adds **no new screens** — #315/#316 are persona-roster + asset changes that surface within existing screens; v6 added D6 guide + G13–G16 Sunday Letter reader; A0 added 2026-05-18; D5 folded into D1, D4 deferred v2, F5 deferred v2, J4 dropped, A2/A3 merged, A6/A7 merged; G5–G11 added 2026-05-28).
...
> - `IMPLEMENTATION_BACKLOG_v19.md` — non-UI implementation work
>
> **Last updated:** 2026-06-16 (v7).
>
> **Changelog v6 → v7 (2026-06-16):**
> - **No new screens.** PRs #315–#316 are persona-roster + portrait-asset changes that surface within existing persona-facing screens (Explore / Library minds list, `PersonaPickerSheet`, Council picker, D6 guide).
> - **Persona portraits → WebP standard (#315)** — all persona portrait imagery is now **WebP (1024px, q82)** in both stores (`apps/web/public/personas/`, `apps/api/static/personas/`); the **D6 guide** screen image `src`s were updated to `.webp` (`app/app/guide/page.tsx`). Any screen rendering a persona portrait now serves WebP. (Persona portraits only — the app-icon and `sundayletter.png` share asset are unaffected.)
> - **Roster 9 → 11 (#316)** — two new **pro-tier** personas, **George Orwell** + **Miyamoto Musashi**, now surface in the minds list / `PersonaPickerSheet` with the **Pro pill** on their portraits (both Pro-gated). **Council default panel unchanged** (Machiavelli, Epictetus, Freud, de Beauvoir) — the new personas are matchable but not added to the fixed Council roster.
>
