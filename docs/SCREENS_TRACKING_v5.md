# GREAT MINDS — Screens Tracking v5
...
> - `IMPLEMENTATION_BACKLOG_v17.md` — non-UI implementation work
>
...
| G11 | Weekly Reading — placeholder card (Rituals tile) | ⚠️ pending (ref Brief #2; "Coming this season" locked card) |
| G12 | You vs You | ✅ shipped (2026-06-02, PRs #193–#202) — forming/locked guard → input (textarea + saved-lines) → dual-self reveal THEN/NOW → closing card (WiseMark + evidence quotes + ring-true + humility line) + usage meter + premium nudge. Pro-gated. Bg: youvsyou.webp. Hub card icon: half-sphere SVG (v5, 2026-06-03). |
...
**End of SCREENS_TRACKING v5.** Authoritative as of 2026-06-03. Supersedes `SCREENS_TRACKING_v4.md` (preserved as historical reference).
