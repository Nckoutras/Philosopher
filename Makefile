...
state:
	...
	@echo ""
	@echo "  Next steps:"
	@echo "  1. Review changes:   git diff docs/PROJECT_STATE.md"
	@echo "  2. Commit:           git add docs/PROJECT_STATE.md && git commit -m 'chore: update state'"
	@echo "  3. Push:             git push"
	@echo "  4. Re-upload to Claude.ai Project Knowledge:"
	@echo "     - Settings → Projects → Philosopher → Project Knowledge"
	@echo "     - Delete old PROJECT_STATE.md"
	@echo "     - Upload docs/PROJECT_STATE.md"
	@echo ""
...
state-help:
	...
	@echo ""
	@echo "WHAT IT DOES:"
	@echo "  Calls Claude Code to read the repo and rewrite docs/PROJECT_STATE.md"
	...
	@echo ""
	@echo "  4. Verify docs/PROJECT_STATE.md exists in repo"
