    ...
    <div className="min-h-dvh flex items-center justify-center px-4" style={{ background: 'var(--bg-primary)' }}>
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-medium mt-3" style={{ fontFamily: 'var(--font-serif)', color: 'var(--text-primary)' }}>Welcome back.</h1>
        </div>
        <div className="rounded-2xl p-7" style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)' }}>
          ...
          <p className="mt-6 text-center text-sm" style={{ color: 'var(--text-muted)' }}>
            No account?{' '}
            <Link href="/auth/register" className="underline" style={{ color: 'var(--gold)' }}>Begin here</Link>
          </p>
        </div>
      </motion.div>
    </div>
