  ...
  return (
    <>
      <div className="bg-paper border border-[0.5px] border-edge rounded-md overflow-hidden">
        ...
        {/* Emerging Patterns — locked shell */}
        <div className="w-full flex items-center justify-between px-[16px] py-[14px] border-t border-[0.5px] border-edge opacity-50">
          <span className="font-cormorant text-[17px] font-medium text-ink">
            Emerging Patterns
          </span>
          <div className="flex items-center gap-[6px]">
            <span className="font-lora text-[11px] text-charcoal">Coming soon</span>
            <Lock size={13} strokeWidth={1.5} className="text-sepia flex-shrink-0" />
          </div>
        </div>

        {/* Weekly Letter — locked shell */}
        <div className="w-full flex items-center justify-between px-[16px] py-[14px] border-t border-[0.5px] border-edge opacity-50">
          <span className="font-cormorant text-[17px] font-medium text-ink">
            Weekly Letter
          </span>
