  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div
        role="dialog"
        aria-modal="true"
        className="absolute inset-x-0 bottom-0 bg-paper rounded-t-xl max-h-[75vh] flex flex-col
                   transform translate-y-0 transition-transform duration-200 ease-out"
      >
        {/* Header */}
