...
async def share_weekly_letter(
    ...
    """
    Mint a share for a Sunday Letter's pull_quote and return its wax-seal card.
    ...
    return await create_and_render(
        ...
        artifact_type="letter", artifact_id=letter_id,
        generator=generate_letter_share_image,
